...
Il existe beaucoup d'algorithmes automatiques pour la détection automatique de modèles ARIMA (TRAMO étant un des plus connus). Ils permettent de trouver un ARIMA$(p,d,q)(P,D,Q)_m$. Décrivons ici l'algorithme utilisé dans `forecast::auto.arima()` :
